...
/**
 * helper_complete - It searches all binary tree nodes and determines
...
/**
 * helper_heap - This will help to check if a binary tree is a valid max binary heap.
...
/**
 * binary_tree_is_heap - This checks if a binary tree is a valid Max Binary Heap.
 * @tree: a pointer to the root node of tree to check.
 *
