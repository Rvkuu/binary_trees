...
/**
 * avl_insert_full - It inserts a value
 *
...
/**
 * val_balancer - This will rebalance an AVL tree if needed
 *
 * @root: A pointer to the root of the tree
 * @tree: A pointer to the node to be rebalanced
...
/**
 * avl_insert - It nserts the value in avl
 *
 * @tree: A double pointer to root
 * @value: the value
