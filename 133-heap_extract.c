...
/**
 * enqueue_item_4 - This adds an item to a queue.
...
/**
 * dequeue_item_4 - It Removes an item from a queue.
 * @queue_h: A pointer to the queue's head.
 * @queue_t: A pointer to the queue's tail.
 * @n: A pointer to the queue's size value.
 *
...
/**
 * swap_tree_node_with_parent_1 - This Swaps a node in a \
 ...
 *		  After been replaced, the heap will be rebuilt if necessary.
